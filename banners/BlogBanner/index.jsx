  ...
  <Fragment>
    <div className="bannerContainer">
      <div className="bannerWrapper">
        <div className="bannerContent">
          <div className="bannerEmoji">
            <img
              className="image"
              src={urlBuilders.imageUrl('banners/book-emoji.svg')}
              alt=""
            />
          </div>
          <span className="bannerText">Our new blog is live</span>
        </div>
        <div className="buttonWrapper">
          <Button hasBorder href={urls.blog}>
      ...
      <div className="bannerLinkWrapper">
        <Anchor color="white" href={urls.blog}>
          <div className="bannerContent">
            <div className="bannerEmoji">
              <img
                className="image"
            ...
            <div className="rotationWrapper">
              ...
              <div className="rotation2">
                <span className="bannerText">Check it out</span>
              </div>
            </div>
            <div className="buttonImage">
              <div className="bannerEmoji">
