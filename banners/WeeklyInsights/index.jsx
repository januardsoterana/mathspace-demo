...
import { breakPoints, colors, desktopFontSizes } from 'utils/theme';
...
const WeeklyInsightsBanner = () => (
  <Fragment>
    <div className="bannerContainer">
      <div className="bannerWrapper">
        <div className="bannerContent">
          <span className="bannerText">
            See which students need assistance, with Weekly Insights
          </span>
        </div>
        <div className="buttonWrapper">
          <Button color="white" hasBorder href={urls.weeklyInsights}>
      ...
      <div className="bannerLinkWrapper">
        <Anchor color="white" href={urls.weeklyInsights}>
          <div className="bannerContent">
            <div className="rotationWrapper">
              ...
              <div className="rotation2">
                <span className="bannerText2">with Weekly Insights</span>
              </div>
            </div>
            <div className="buttonImage">
...
export default WeeklyInsightsBanner;
