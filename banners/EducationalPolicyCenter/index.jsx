...
const WEBINAR_BANNER = 'webinar-banner';
const LOCALE_DATA = {
  AU: {
    bannerTextDesktop:
      'US Education Policy Centre recognises our impact on student growth',
    ctaText: 'Learn more',
    bannerTextOneMobile: 'US Education Policy Centre recognises',
    bannerTextTwoMobile: 'our impact on student growth',
    ctaLink:
      'https://blog.mathspace.co/utah-education-policy-center-recognizes-mathspaces-impact-on-student-growth/',
  },
  US: {
    bannerTextDesktop:
      'Utah Education Policy Center recognizes our impact on student growth',
    ctaText: 'Learn more',
    bannerTextOneMobile: 'Utah Education Policy Center recognizes',
    bannerTextTwoMobile: 'our impact on student growth',
    ctaLink:
      'https://blog.mathspace.co/utah-education-policy-center-recognizes-mathspaces-impact-on-student-growth/',
  },
...
const EducationPolicyCenter = ({ country }: Props) => (
  <Fragment>
    <div className="bannerContainer">
      <div className="bannerWrapper">
        <div className="bannerContent">
          <span className="bannerText">
            {LOCALE_DATA[country].bannerTextDesktop}
          </span>
        </div>
        <div className="buttonWrapper">
          <Button
            color="white"
            hasBorder
            href={LOCALE_DATA[country].ctaLink}
            onClick={event => {
              event.preventDefault();
              sendCTAClickEvent(WEBINAR_BANNER)
                .then(() => {
                  window.location.assign(LOCALE_DATA[country].ctaLink);
                })
                .catch(() => {
                  window.location.assign(LOCALE_DATA[country].ctaLink);
                });
          ...
          >
            <span>{LOCALE_DATA[country].ctaText}</span>
          ...
          <div className="bannerContent">
            <div className="rotationWrapper">
              <div className="rotation1">
                <span className="bannerText">
                  {LOCALE_DATA[country].bannerTextOneMobile}
                </span>
              </div>
              <div className="rotation2">
                <span className="bannerText">
                  {LOCALE_DATA[country].bannerTextTwoMobile}
                </span>
              </div>
            </div>
            <div className="buttonImage">
...
export default EducationPolicyCenter;
