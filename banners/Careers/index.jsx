...
const CAREERS_BANNER = 'careers-banner';
      ...
      <div className="bannerWrapper">
        <div className="bannerContent">
          <span className="bannerText">
            We&apos;re hiring! Positions open for teachers from NSW, QLD and VIC
          </span>
        </div>
        <div className="buttonWrapper">
          <Button
            ...
            hasBorder
            href={urls.careers}
            data-event-label={CAREERS_BANNER}
            onClick={event => {
              event.preventDefault();
              sendCTAClickEvent(CAREERS_BANNER)
                .then(() => {
                  window.location.assign(urls.careers);
                })
                .catch(() => {
                  window.location.assign(urls.careers);
                });
          ...
          <div className="bannerContent">
            <div className="rotationWrapper">
              <div className="rotation1">
                <span className="bannerText">
                  We&apos;re hiring! Positions open for
                </span>
              </div>
              <div className="rotation2">
                <span className="bannerText">
                  teachers from NSW, QLD and VIC
                </span>
              </div>
            </div>
            <div className="buttonImage">
