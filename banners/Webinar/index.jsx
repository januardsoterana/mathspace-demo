...
const webinarLink = `${urls.webinar}/registration?id=9`;
      ...
      <div className="bannerWrapper">
        <div className="bannerContent">
          <span className="bannerText">
            PD webinar presented by Mathspace CEO, Mohamad Jebara
          </span>
        </div>
        <div className="buttonWrapper">
          <Button
            color="white"
            hasBorder
            href={`${urls.webinar}/registration?id=9`}
            onClick={event => {
              event.preventDefault();
              sendCTAClickEvent(WEBINAR_BANNER)
                .then(() => {
                  window.location.assign(webinarLink);
                })
                .catch(() => {
                  window.location.assign(webinarLink);
                });
          ...
          <div className="bannerContent">
            <div className="rotationWrapper">
              <div className="rotation1">
                <span className="bannerText">PD webinar presented by</span>
              </div>
              <div className="rotation2">
                <span className="bannerText">
                  Mathspace CEO, Mohamad Jebara
                </span>
              </div>
            </div>
            <div className="buttonImage">
