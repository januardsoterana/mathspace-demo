...
const BLOG_ARTICLE_LINK =
  'https://blog.mathspace.co/introducing-the-2020-editions/';
...
const TwentyTwentyEditionBanner = () => (
  <Fragment>
    <div className="bannerContainer">
      <div className="bannerWrapper">
        <div className="bannerContent">
          <span className="bannerText">Our biggest content upgrade ever</span>
        </div>
        <div className="buttonWrapper">
          <Button hasBorder href={BLOG_ARTICLE_LINK}>
            <span>See our 2020 editions</span>
      ...
      <div className="bannerLinkWrapper">
        <Anchor color="white" href={BLOG_ARTICLE_LINK}>
          <div className="bannerContent">
            <div className="rotationWrapper">
              <div className="rotation1">
                <span className="bannerText">
                  Our biggest content upgrade ever
                </span>
              </div>
              <div className="rotation2">
                <span className="bannerText">See our 2020 editions</span>
              </div>
            </div>
            <div className="buttonImage">
...
export default TwentyTwentyEditionBanner;
