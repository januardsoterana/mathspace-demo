...
const OptIn = () => {
  ...
  return (
    <>
      <div className="panel">
        <PanelTitle>
          Be one of the first globally to experience Waypoints
        </PanelTitle>
        <Separator size={24} />
        <div className="panel__description">
          We have a unique opportunity available to 100 schools to experience
          Waypoints before the official launch in 2021.
        </div>
        <Separator size={32} />
        <Button
          isCTA
