...
const Team = () => (
  <>
    <div className="panel">
      <PanelTitle>
        Built by the team behind leading maths platform, Mathspace
      </PanelTitle>
      <div className="profiles">
        <div className="profile profile--mo">
          ...
          <div>
            ...
            <div className="profile__description">
              More data is not what teachers need. Edtech is filled with
        ...
        <div className="profile profile--alvin">
          ...
          <div>
            ...
            <Separator size={20} />
            <div className="profile__description">
              In the 10 years I’ve been involved in edtech, this is one of the
